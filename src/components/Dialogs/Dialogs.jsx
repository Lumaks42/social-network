    ...
    return <div className={d.blockDialogs}>
        ...
        <div>
            ...
            <div className={d.blockInputMsg}>
                <textarea ref={newMsg} className={d.inputField}/>
                <div className={d.blockBtn}>
                    ...
                    <button onClick = { addNewMsg } className={d.btnMsg + ' ' + d.btn}><img src="./public/content/btnMessage.png" className={d.btnMsg}/></button>
                </div>
            </div>
        </div>
    </div>
